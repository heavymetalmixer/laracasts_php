<nav class="bg-gray-800">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <a href="/about" class="<?= $_SERVER["REQUEST_URI"] === "/about" ? "br-gray-900 text-white" : "text-gray-300"; ?>">About</a>
            <a href="/contact" class="<?= $_SERVER["REQUEST_URI"] === "/contact" ? "br-gray-900 text-white" : "text-gray-300"; ?>">Contact</a>
            </div>
        </div>
        </div>
        <div class="hidden md:block">
