<nav class="bg-gray-800">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <a href="/" class="<?= urlIs("/") ? "br-gray-900 text-white" : "text-gray-300"; ?>" aria-current="page">Home</a>
            <a href="/about.php" class="<?= $_SERVER["REQUEST_URI"] === "/about.php" ? "br-gray-900 text-white" : "text-gray-300"; ?>">About</a>
            <a href="/contact.php" class="<?= $_SERVER["REQUEST_URI"] === "/contact.php" ? "br-gray-900 text-white" : "text-gray-300"; ?>">Contact</a>
            </div>
        </div>
        </div>
        <div class="hidden md:block">
